...
# PAC parameters
env_batch_size = 5 # Number of environments to sample
...
for i in range(epoch):
    print("epoch: ", i)
    compute_gradient(env_batch_size,params, husky, sphere, nn_controller)
    if i%5==0 and i>0:
        cost, fail_rate=environment_costs(env_validation_batch_size, nn_controller, params, husky, sphere, GUI, random_seed, 1)
...
cost, fail_rate_for_test = environment_costs(numEnvs, nn_controller, params, husky, sphere, GUI, seed, 1)
